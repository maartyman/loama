...
Please provide your own WebID for authorization: https://solidme.web/harrypodder/profile/card#me
...
What action do you want to associate? Choose one below: 
        ...
        - control [5]
1
Please enter the URL to the resource: http://localhost:3000/harry/podder/resource.txt
